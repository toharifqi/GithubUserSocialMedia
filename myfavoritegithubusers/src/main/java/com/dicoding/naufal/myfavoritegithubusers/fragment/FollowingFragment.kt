...
import com.dicoding.naufal.myfavoritegithubusers.databinding.FragmentFollowingBinding
...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        userViewModel.getUser().observe(viewLifecycleOwner, object :
        ...
        showLoading(true)
        userViewModel.setUser(username.toString(), UserViewModel.FOLLOWING_KEY)
    }
